...
# try: It is  mandatory clause in exception handling.try runs first in try__except

# except: if python runs into an exception, then code present in except will run.
